...
<div class="footer">
    <div class="container">
        <div class="store">
            <ul>
                <li class="active">OUR MARKET POINTS::</li>
                <p>CAMEROON: LINKING ALL MAJOR TOWNS</p>
                <li><a href="#">Adamauoa |</a></li>
        ...
        <div class="copywrite">
            <p>Copyright © 2015 Go-Groups Ltd | Developers: <a href="http://go-groups.net">Pius&&Fru</a></p>
        </div>
    </div>
</div>
</div>
