...
@section('header')
    @include('menu')
<!--A Design GO-Groups Ltd
Author: Ngwa Pius/Isidore Fru Che
Author URL: http://go-groups.net
	 ...
	 <div class="container">
		 <div class="slider">
				<ul class="rslides" id="slider1">
                  <li><img src="{{URL::asset('images/logo.png')}}" alt=""></li>
				  <li><img src="{{URL::asset('images/deco.jpg')}}" alt=""></li>
                  <li><img src="{{URL::asset('images/fruit.jpg')}}" alt=""></li>
				  <li><img src="{{URL::asset('images/deco1.jpg')}}" alt=""></li>
	 ...
	 <div class="container">
		 <div class="sofas">
			 <div class="col-md-6 sofa-grid">
				 ...
				 <h4><a href="{{action('DisplayProductController@food')}}">SPECIAL ACCENTS OFFER</a></h4>
			 </div>
...
<div class="new">
	 <div class="container">
		 ...
		 <div class="new-items">
			 <div class="item1">
				 <a href="{{action('DisplayProductController@food')}}"><img src="images/s1.jpg" alt=""/></a>
				 <div class="item-info">
			 ...
			 <div class="item4">
				 <a href="{{action('DisplayProductController@food')}}"><img src="images/s4.jpg" alt=""/></a>
