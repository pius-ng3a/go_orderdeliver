@extends('app')
@section('header')
    <p><h1>content goes here</h1></p>
    @foreach($user as $auser)
    <li>{{ $auser }}</li>
    @endforeach
@stop

{{-- 27 october for ownedproductview--}}
@extends('app')
@section('header')
    @include('menu')
@endsection
                ...
                @foreach($items as $item)
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <section  class="sky-form">
                                    <h4><span class="glyphicon glyphicon-minus" aria-hidden="true"></span>DISCOUNTS ON</h4>
                                    <h4><span>{{$item->item_name}}</span></h4>
                            ...
                            {{--Left panel goes here with statistics.--}}
                        </div>
                    @endif
                    <div class="col-md-9 product-model-sec">
                                ...
                                <div  >
                                    ...
                                    <a href="single.html"><div class="product-grid love-grid">
                                            ...
                                            <div class="product-img b-link-stripe b-animate-go  thickbox">
                                                <img src="{{asset('images/'.$item->category.'/'.$item->picture)}}" class="img-responsive" alt="" height="100px" width="100px"/>
                                                <div class="b-wrapper">
                        ...
                        @else
                            ...
                            {!! Form::open(['route'=>'show_products','class'=>'col-md-4']) !!}
                            <a href="single.html"><div class="product-grid love-grid">
                                    <div class="more-product"><span> </span></div>
                                    <div class="product-img b-link-stripe b-animate-go  thickbox">
                                        <img src="{{asset('images/'.$item->category.'/'.$item->picture)}}" class="img-responsive" alt="" height="100px" width="100px"/>
                                    ...
                                    @if($r ==0)
                                        <div class="row">
                                            ...
                                            <a href="single.html"><div class="product-grid love-grid">
                                                    <div class="more-product"><span> </span></div>
                                                    <div class="product-img b-link-stripe b-animate-go  thickbox">
                                                        <img src="{{asset('images/'.$item->category.'/'.$item->picture)}}" class="img-responsive" alt=""/>
                                                        <div class="b-wrapper">
                                                            <h4 class="b-animate b-from-left  b-delay03">
                                                                <button class="btns"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>Quick View</button>
                                                            </h4>
